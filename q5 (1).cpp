...
void Spent(Budget& B)
{
	...
	cout << "How much amount was soent on Housing? ";
	cin >> B.Housing;
	cout << "How much amount was soent on Utilities? ";
	cin >> B.Utilities;
	cout << "How much amount was soent on Household expenses? ";
	cin >> B.HouseholdExpense;
	cout << "How much amount was soent on Transportation? ";
	cin >> B.Transportation;
	cout << "How much amount was soent on Food? ";
	cin >> B.Food;
	cout << "How much amount was soent on Medical? ";
	cin >> B.Medical;
	cout << "How much amount was soent on Insurance? ";
	cin >> B.Insurance;
	cout << "How much amount was soent on Entertainment? ";
	cin >> B.Entertainment;
	cout << "How much amount was soent on Clothing? ";
	cin >> B.Clothing;
	cout << "How much amount was soent on Miscellaneous? ";
	cin >> B.Miscellaneous;
}
